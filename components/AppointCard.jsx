...
export default function AppointCard({ story, colorScheme, horizontal }) {
      ...
      {horizontal === false && (
        <View style={styles.card}>
          ...
          <View style={styles.cardContentContainer}>
            ...
            {story.type === 2 && <Text style={styles.cardTagType}>城限</Text>}
        ...
        <View style={styles.cardHorizantal}>
          ...
          <View style={styles.cardContentContainerHorizantal}>
            ...
            <View style={styles.cardTagContainer}>
              {Array.from({ length: story.tag.length }).map((_, index) => {
                return (
                  <Text key={index} style={styles.cardTagHorizantal}>
                    {story.tag[index]}
                  </Text>
                );
              })}
